...
namespace FronkonGames.Artistic.Neon
{
  ...
  {
    private static Neon renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (Neon)CreateInstance(typeof(Neon).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is Neon)
                renderFeature = scriptableRendererData.rendererFeatures[i] as Neon;
            }
          }
        }
