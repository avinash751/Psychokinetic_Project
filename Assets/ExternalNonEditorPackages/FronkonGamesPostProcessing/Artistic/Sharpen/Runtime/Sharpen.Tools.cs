...
namespace FronkonGames.Artistic.Sharpen
{
  ...
  {
    private static Sharpen renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (Sharpen)CreateInstance(typeof(Sharpen).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is Sharpen)
                renderFeature = scriptableRendererData.rendererFeatures[i] as Sharpen;
            }
          }
        }
