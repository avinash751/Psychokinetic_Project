    ...
    protected override void InspectorGUI()
    {
      ...
      switch (settings.colorMode)
      {
        ...
        case ColorModes.Gradient:
          ...
          settings.gradient = GradientField("Gradient", "Color gradient mode", settings.gradient, OneBit.Settings.DefaultGradient);
