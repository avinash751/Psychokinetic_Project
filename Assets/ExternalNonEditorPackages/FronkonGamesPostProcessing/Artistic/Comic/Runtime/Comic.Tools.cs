...
namespace FronkonGames.Artistic.Comic
{
  ...
  {
    private static Comic renderFeature;
    ...
    public static void AddRenderFeature()
    {
      if (IsInRenderFeatures() == false)
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          renderFeature = (Comic)CreateInstance(typeof(Comic).ToString());
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is Comic)
                renderFeature = scriptableRendererData.rendererFeatures[i] as Comic;
            }
          }
        }
